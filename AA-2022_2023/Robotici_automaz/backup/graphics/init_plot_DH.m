...
for j = 1:nj
    ...
    % plot link
    surf(linkX, linkY, linkZ, 'facecolor', 'b', 'edgecolor', 'none', 'parent', parent); % cylinder
    fill3(linkX(1,:), linkY(1,:),  linkZ(1,:), 'b', 'parent', parent); % fill top
    fill3(linkX(2,:), linkY(2,:),  linkZ(2,:), 'b', 'parent', parent); % fill bottom
end
